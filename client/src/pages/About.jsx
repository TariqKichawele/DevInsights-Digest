      ...
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div>
          <h1 className='text-3xl font font-semibold text-center my-7'>
            About DevInsights Digest
          </h1>
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            <p>
              Welcome to DevInsights! This blog-site was created by (myself) Tariq Kichawele
            ...
            <p>
              I encourage to leave comments on posts and engage with
              other readers. You can like other members comments and reply to
